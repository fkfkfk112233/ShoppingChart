...
public class AddUser extends JFrame {
	...
	public AddUser() {
		...
		lblNewLabel.setBounds(135, 10, 50, 50);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("帳號：");
		lblNewLabel_1.setFont(new Font("新細明體", Font.BOLD, 14));
		lblNewLabel_1.setBounds(35, 70, 45, 30);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("密碼：");
		lblNewLabel_1_1.setFont(new Font("新細明體", Font.BOLD, 14));
		lblNewLabel_1_1.setBounds(35, 110, 45, 30);
		contentPane.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_1_1_1 = new JLabel("姓名：");
		lblNewLabel_1_1_1.setFont(new Font("新細明體", Font.BOLD, 14));
		lblNewLabel_1_1_1.setBounds(35, 150, 45, 30);
		contentPane.add(lblNewLabel_1_1_1);
		
		acc = new JTextField();
		acc.setBounds(90, 75, 210, 20);
		contentPane.add(acc);
		acc.setColumns(10);
		
		pwd = new JTextField();
		pwd.setColumns(10);
		pwd.setBounds(90, 115, 210, 20);
		contentPane.add(pwd);
		
		name = new JTextField();
		name.setBounds(90, 155, 96, 20);
		contentPane.add(name);
		name.setColumns(10);
		
		JComboBox role = new JComboBox();
		role.setModel(new DefaultComboBoxModel(new String[] {"一般使用者", "管理員"}));
